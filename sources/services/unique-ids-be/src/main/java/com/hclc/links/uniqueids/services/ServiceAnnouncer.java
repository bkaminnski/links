package com.hclc.links.uniqueids.services;
...
import static com.hclc.links.uniqueids.EventsNames.myServiceIsAvailable;
import static com.hclc.links.uniqueids.EventsNames.myServiceIsUnavailable;
...
public class ServiceAnnouncer {
    ...
    public void announceServiceAvailability() {
        String uiUrlPayload = Json.createObjectBuilder().add("uiUrl", serviceInfo.fullUrlTo("/unique-ids/app/app.js")).build().toString();
