...
import static com.hclc.links.users.EventsNames.myServiceIsAvailable;
...
public class ServiceAnnouncer {
    ...
    public void announceServiceUnavailability() {
        linksTopic.sendEventWithEmptyPayload(EventsNames.myServiceIsUnavailable, serviceLogger);
    }
}
