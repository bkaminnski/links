package com.hclc.links.monitoring.services;
...
import static com.hclc.links.monitoring.EventsNames.myServiceIsAvailable;
import static com.hclc.links.monitoring.EventsNames.myServiceIsUnavailable;
...
public class ServiceAnnouncer {
    ...
    public void announceServiceAvailability() {
        String uiUrlPayload = Json.createObjectBuilder().add("uiUrl", serviceInfo.fullUrlTo("/monitoring/app/app.js")).build().toString();
