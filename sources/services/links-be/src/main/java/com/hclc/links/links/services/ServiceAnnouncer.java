...
import static com.hclc.links.links.EventsNames.myServiceIsAvailable;
import static com.hclc.links.links.EventsNames.myServiceIsUnavailable;
...
public class ServiceAnnouncer {
    ...
    public void announceServiceAvailability() {
        String uiUrlPayload = Json.createObjectBuilder().add("uiUrl", serviceInfo.fullUrlTo("/links/app/app.js")).build().toString();
