$machineName = "links-docker-machine"
...
if ($dockerMachines -Like "*$machineName*") {
	...
	docker-machine create --driver virtualbox --virtualbox-disk-size "10000" --virtualbox-memory "8192" --virtualbox-cpu-count "4" $machineName
	docker-machine start $machineName
	docker-machine env $machineName
	&docker-machine env $machineName | Invoke-Expression
